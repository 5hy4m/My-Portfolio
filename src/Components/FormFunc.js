  ...
  if (thx) {
    var content = (
      ...
      >
        <h1 className="thx">
          Thank YOu.
          <span className="text-primary">I'll Get back to you shortly!</span>
        </h1>
      </section>
    );
  } else {
      ...
      >
        ...
        <div className=" formcontent d-flex w-100">
          <form action="post w-100">
            <label className="subheading mb-3" htmlFor="fname">
              Name:
            </label>
            <input
              required="true"
              className="ml-2 name shadow"
              type="text"
              id="fname"
              name="fname"
            />
            <br />
            <label className="subheading  mb-3" htmlFor="lname">
              Email id:
            </label>
            <input
              required="true"
              className="ml-2 emailid shadow"
              type="text"
              id="lname"
              name="lname"
            />
            ...
            <input
              required="true"
              className="ml-2 shadow phno"
              type="text"
              id="lname"
              name="lname"
            />
            <br />
            <textarea rows="4" placeholder="Message" className="shadow msg" />
            <br />
            <br />{' '}
            {/* <input className = "ml-2" type="text" id="lname" name="lname" defaultValue="Doe"/><br/><br/> */}
            <input
